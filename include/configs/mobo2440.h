...
#define MACH_TYPE_MOBO2440 	168
#define CONFIG_MACH_TYPE	MACH_TYPE_MOBO2440
...
#define CONFIG_SYS_PROMPT	"MoBo2440 => "
 ...
 * DRAM is not init
 */
#define CONFIG_SYS_INIT_SP_ADDR		(0x32000000)
...
#define CONFIG_ENV_OFFSET 0x80000   //env 偏移量512K
#define CMD_SAVEENV    //save env
